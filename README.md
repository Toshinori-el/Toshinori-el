...
🔌 Técnico em Eletrotécnica | 💻 Desenvolvedor Python em formação | 🤖 Apaixonado por Automação e Indústria 4.0

### Sobre mim
- 🎓 Técnico em Eletrotécnica por formação, desenvolvedor por vocação.
...
### ⚡ Áreas de Interesse
- Automação Industrial e Comandos Elétricos
- Internet das Coisas (IoT)
- Desenvolvimento de ferramentas web para engenharia
- Análise de dados aplicada à indústria
-->
